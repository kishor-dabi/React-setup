...
export const GET_DISEASE_LIST_START = "GET_DISEASE_LIST_START";
export const GET_DISEASE_LIST_FAIL = "GET_DISEASE_LIST_FAIL";
...
export const GET_USER_DOCTOR_PAYMENT_START = "GET_USER_DOCTOR_PAYMENT_START";
export const GET_USER_DOCTOR_PAYMENT_FAIL = "GET_USER_DOCTOR_PAYMENT_FAIL";
export const GET_USER_DOCTOR_PAYMENT_SUCCESS = "GET_USER_DOCTOR_PAYMENT_SUCCESS";
