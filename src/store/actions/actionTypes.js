...
export const DASHBOARD_DR_GET = "DASHBOARD_DR_GET";
export const DASHBOARD_DR_GET_SUCCESS = "DASHBOARD_DR_GET_SUCCESS";
export const DASHBOARD_DR_GET_FAIL = "DASHBOARD_DR_GET_FAIL";
